...
describe Request do
  shared_context 'create two users and two spaces' do
    before do
  ...
  describe 'creating requests' do
    include_context 'create two users and two spaces'
  ...
  describe 'method: check_availablilty' do
    ...
    describe '.show_sent_requests' do
      include_context 'create two users and two spaces'
    ...
    describe '.find_properties' do
      it 'finds all properties with same owner' do
        ...
        expect(find_properties).to eq ["1"]
      end
    end
